class Webcam {
    ...
    //---------------------------------------------
    // mirror video image (left/right)
    //---------------------------------------------
    mirror() {
      if (this.videoIsMirrored()) {
        this._webcamElement.style.transform = '';
      } else {
    ...
    //---------------------------------------------
    // take snapshot and load it into the canvas
    //---------------------------------------------
    snap() {
    ...
    //---------------------------------------------
    // test whether the video is currently mirrored
    //---------------------------------------------
    videoIsMirrored() {
      return this._webcamElement.style.transform != '';
    }
}